...
class Business(models.Model):
    ...
    cp_img =  models.ImageField(upload_to='contact_person/%Y/%m/%d/', blank=True, null=True, help_text='cp short for contact person' )
    cp_phone_1 = models.CharField(max_length=100, blank=True, null=True)
    cp_phone_2 = models.CharField(max_length=100, blank=True, null=True)
    cp_email_1 = models.CharField(max_length=100, blank=True, null=True)
    ...
    bgimg1 =  models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True )
    bgimg2 =  models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True )
    bgimg3 =  models.ImageField(upload_to='photos/%Y/%m/%d/', blank=False, null=True )
    about_business = RichTextField(blank=False, null=True, help_text="Max 200 words")
    services = RichTextField(blank=False, null=True, help_text="Max 200 words")
...
class Feature(models.Model):
    business_name = models.ForeignKey(Business, on_delete=models.DO_NOTHING,  blank=True, null=True, help_text='optional')
    f_title1 = models.CharField(max_length=200, blank=True, null=True, help_text='feature title 1')
    features_1 = models.CharField(max_length=1000, blank=True, null=True)
    f_title2 = models.CharField(max_length=200, blank=True, null=True, help_text='feature title 2')
    features_2 = models.CharField(max_length=1000, blank=True, null=True)
