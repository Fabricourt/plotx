    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Neighbor')),
                ('payment_plan', models.ForeignKey(help_text='mode of payment required', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Payment_plan')),
                ('plot_size', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Plot_size')),
                ('plot_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Plot_status')),
                ('plot_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Plot_type')),
                ('population', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Population')),
                ('roads', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Road')),
                ('text_color', models.ForeignKey(blank=True, help_text='optional', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Text_color')),
                ('town', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='towns.Town')),
            ],
        ),
    ]
